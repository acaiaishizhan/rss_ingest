...
FEISHU_FILTERED_TABLE_LINK = read_env_str("FEISHU_FILTERED_TABLE_LINK")
...
NVIDIA_SCREEN_MODEL = read_env_str("NVIDIA_SCREEN_MODEL")
NVIDIA_SUMMARIZE_MODEL = read_env_str("NVIDIA_SUMMARIZE_MODEL")
...
FEISHU_FILTERED_APP_TOKEN = extract_bitable_app_token(FEISHU_FILTERED_TABLE_LINK)
FEISHU_FILTERED_TABLE_ID = extract_bitable_table_id(FEISHU_FILTERED_TABLE_LINK)
...
LLM_CONCURRENCY = read_env_int("LLM_CONCURRENCY", 5, minimum=1)
PROGRESS_BAR_WIDTH = read_env_int("PROGRESS_BAR_WIDTH", 20, minimum=1)
PROMPT_TITLE_MAX_CHARS = read_env_int("PROMPT_TITLE_MAX_CHARS", 300, minimum=32)
PROMPT_CONTENT_MAX_CHARS = read_env_int("PROMPT_CONTENT_MAX_CHARS", 12000, minimum=512)
AUTO_FETCH_INTERVAL_HOURS = read_env_int("AUTO_FETCH_INTERVAL_HOURS", 3, minimum=1)
